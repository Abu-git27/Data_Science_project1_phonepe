...
def run():
    ...
    st.markdown("### 🔹 Engagement Pattern: App Opens vs Registered Users")
    ...
    st.markdown("### 🔹 State-wise Spread of Engagement Ratio (Rotated Axes)")
    ...
    st.markdown("### 🔹 Top 10 Districts by Engagement Ratio")
